...
public class DialogFornecedor extends javax.swing.JDialog {
    ...
    public void validaFormulario(){
        ...
        if (textCnpj.getText().equals("   .   .  -  ")){
            JOptionPane.showMessageDialog(null, "Cnpj obrigátorio");
    ...
    private void carregaPessoa(){
       DefaultComboBoxModel cbm = new DefaultComboBoxModel(TipoPessoa.values());
        comboPessoa.setModel(cbm);
    }
    private void carregaCidade(){
        List<Cidade> lista = daoCidade.getCidadeList();
        tableCidade.setModel(
            new MyTableModel(Cidade.class, lista, tableCidade)
        );  
    }
    private void carregaCidade(String filtro){        
        List<Cidade> lista = daoCidade.getCidadeList(filtro);
        tableCidade.setModel(
            new MyTableModel(Cidade.class, lista, tableCidade)
        ); 
    }
    
    private void carregaFornecedors() throws SQLException{
        List<Fornecedor> lista = dao.getFornecedorList();
        tableFornecedor.setModel(
            new MyTableModel(Fornecedor.class, lista, tableFornecedor)
        );
    }
    private void carregaFornecedor(String filtro){
        List<Fornecedor> lista = dao.getFornecedorList(filtro);
        tableFornecedor.setModel(
            new MyTableModel(Fornecedor.class, lista, tableFornecedor)
        );
    }
    ...
    private Fornecedor populateFornecedor() throws ParseException{
        ...
        return (new Fornecedor(
                    ...
                    (Cidade)daoCidade.getCidade(idCidade),
                    (radioAtivo.isSelected()?0:1),
                    (TipoPessoa)comboPessoa.getSelectedItem()
        ));
    }
    //preencher os componentes com o objeto
    private void populateComponente(Fornecedor fornecedor){
        textId.setText(fornecedor.getId()+"");
        ...
        textIdCidade.setText(fornecedor.getCidade().getId()+"");
        textCidade.setText(fornecedor.getCidade().getNome());
        comboPessoa.setSelectedItem(fornecedor.getPessoa());
        if(0 == (fornecedor.getStatus())){
            radioAtivo.setSelected(true);
        }else{
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(comboPessoa, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(26, 26, 26)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(textCnpj, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void tableFornecedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableFornecedorMouseClicked
        ...
        if (evt.getClickCount()==2) {
            String valor = tableFornecedor.getValueAt(tableFornecedor.getSelectedRow(), 0)+"";
            int codigo = Integer.parseInt(valor);
            populateComponente(dao.getFornecedor(codigo));
        }
    ...
    private void buttonFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFiltrarActionPerformed
        this.carregaFornecedor(textFiltro.getText());
    ...
    private void buttonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverActionPerformed
        ...
        try{
            dao.deleteFornecedor(this.populateFornecedor());
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        try{
            ...
            if(textId.getText().isEmpty()){
                dao.addFornecedor(this.populateFornecedor());
            }else{//atualização
                dao.updateFornecedor(this.populateFornecedor());
            }
            this.iniciaComponentes();
            this.carregaFornecedors();
        }catch(SQLException | ParseException ex){
    ...
    private void tableCidadeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCidadeMouseClicked
        ...
        if (evt.getClickCount()==2) {
            ...
            populateComponenteCidade(daoCidade.getCidade(idCidade));
        }
