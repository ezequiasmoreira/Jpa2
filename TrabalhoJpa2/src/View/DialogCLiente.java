...
public class DialogCLiente extends javax.swing.JDialog {
    ...
    private Cliente populateObject() throws ParseException, SQLException{
        ...
        int idCidade = 0;
        idCidade = Integer.parseInt(textIdCidade.getText());
        ...
        return (new Cliente(
                    ...
                    sdf.parse(textDataNascimento.getText()),
    ...
    private void populateComponente(Cliente cliente){
        ...
        textIdCidade.setText(cliente.getCidade().getId()+"");
        textCidade.setText(cliente.getCidade().getNome());
        comboSexo.setSelectedItem(cliente.getSexo());
        if(0  == (cliente.getStatus())){
            radioAtivo.setSelected(true);
        }else{
